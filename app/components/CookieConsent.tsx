...
export default function CookieConsent() {
  ...
  const handleDecline = () => {
    ...
    // Note: Analytics still enabled even when declined
    // if (typeof window !== 'undefined' && window.gtag) {
    //   window.gtag('consent', 'update', {
  ...
  return (
    <AnimatePresence>
      {showBanner && (
        ...
        >
          <div className="rounded-xl bg-[#0a0a0a]/80 backdrop-blur-xl shadow-2xl border border-white/20 p-4" style={{ boxShadow: "0 8px 32px 0 rgba(0, 102, 255, 0.15), 0 0 0 1px rgba(255, 255, 255, 0.1)" }}>
